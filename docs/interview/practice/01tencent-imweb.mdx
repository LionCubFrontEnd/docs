...
（关注下面题目，如果有 dalao 在，可以评论区答复，欢迎交流，我会以数字序号标注题目）
...
### 4、你知道打开 `https:www.qq.com` 经历了什么吗？
...
我提及到了 Vue 2.0 和 Vue 3.0 区别 以及 proxy 还能做些什么
...
[原题地址及解析](https://chocolate.blog.csdn.net/article/details/104907304)
